**I modelled the air war over the Taiwan Strait. Result: the US tops out at 88.6 fighters airborne over the Strait against China's 380 — a force ratio of 4.3:1 against. It can't be fixed by buying aircraft.**

 |US|China
---|---|---
Fighters committed|390 (+72 tankers)|750
Airborne over the Strait|**88.6**|**380.1**
**Force ratio**|**4.3 : 1 against**|
...
390 + 72 is the self-consistent maximum. Send more airframes and there's nowhere to put them.

*That's a force ratio, not a kill ratio. The engagement model derives a Lanchester exponent of ~0.56, so LER ≈ force_ratio^0.56 — 4.3:1 implies ~1:2.3 in losses. Simulated runs give 1:2.3 to 1:4.0.*
...
400nm|**can't reach**|1.37h|1.68h|2.43h
600nm|can't reach|0.12h|0.44h|1.18h
...
---|---|---|---
Kyushu|735nm|0.243|~120
W Honshu|856nm|0.229|~130
C Honshu|1,033nm|0.212|~140
Kanto|1,133nm|0.203|~60
Guam|1,270nm|0.192|~90
Misawa|1,412nm|0.182|~80
...
Taiwanese aircraft are gone in the opening phase. Allied JASDF fighters hit the *same* ceiling — the constraint is airframes in theatre, not US airframes: 200 of them need ~37 more tankers costing ~111 ramp spots against a system already at 607/620. They change the composition of the 390, not the total.
